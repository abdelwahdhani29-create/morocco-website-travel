...
export const postMoroccoCostOfTravel = {
  ...
  content: {
    en: `
      ...
      <p>To help you set a realistic daily allowance, we have broken down Morocco travel expenses into three clear tiers: <strong>Backpacker / Budget</strong>, <strong>Mid-Range / Comfort</strong>, and <strong>Luxury / High-End</strong>.</p>
        ...
        <table>
          <thead>
            <tr style="background-color: #f7f6f5; color: var(--color-charcoal); font-weight: 700; border-bottom: 2px solid var(--color-border);">
              <th style="padding: 12px 16px;">Travel Style</th>
              <th style="padding: 12px 16px;">Daily Cost (MAD)</th>
              <th style="padding: 12px 16px;">Daily Cost (USD)</th>
              <th style="padding: 12px 16px;">What's Included?</th>
            </tr>
          </thead>
          <tbody>
            <tr style="border-bottom: 1px solid var(--color-border);">
              <td style="padding: 12px 16px; font-weight: 600; color: #16a34a;">Budget / Backpacker</td>
              <td style="padding: 12px 16px;">350 – 550 MAD</td>
              <td style="padding: 12px 16px; font-weight: 600;">$35 – $55 USD</td>
              <td style="padding: 12px 16px;">Hostel dorm or budget guesthouse, street food & local canteens, buses/trams, free sights & self-guided walks.</td>
            </tr>
            <tr style="border-bottom: 1px solid var(--color-border); background-color: #fdfdfd;">
              <td style="padding: 12px 16px; font-weight: 600; color: #2563eb;">Mid-Range (Sweet Spot)</td>
              <td style="padding: 12px 16px;">900 – 1,800 MAD</td>
              <td style="padding: 12px 16px; font-weight: 600;">$90 – $180 USD</td>
              <td style="padding: 12px 16px;">Private room in authentic boutique riad with breakfast, rooftop dinners, first-class trains, museum entries, shared desert tour.</td>
            </tr>
            <tr style="border-bottom: none;">
              <td style="padding: 12px 16px; font-weight: 600; color: #7c3aed;">Luxury / High-End</td>
              <td style="padding: 12px 16px;">3,500 – 8,000+ MAD</td>
              <td style="padding: 12px 16px; font-weight: 600;">$350 – $800+ USD</td>
              <td style="padding: 12px 16px;">5-star luxury palatial riad/resort, fine dining, private SUV driver, bespoke luxury desert camp, private hammam spa.</td>
            </tr>
          </tbody>
        </table>
      </div>

      <h2>1. Accommodation Costs: Hostels, Traditional Riads & Luxury Palaces</h2>
      <p>Where you lay your head each night will be your single biggest expense in Morocco. Fortunately, the range of accommodation in Morocco is unmatched. A <strong>Riad</strong>—a traditional Moroccan mansion built around a tranquil central courtyard fountain—is a highlight of any trip.</p>

      <h3>Budget Hostels & Guesthouses (100 – 300 MAD / $10 – $30 per night)</h3>
      ...
      <div class="blog-highlight">
        <p><strong>📌 Note on Tourist City Tax:</strong> Most hotels and riads charge a mandatory government city tax (<em>Taxe de Séjour</em>) of roughly 20 to 45 MAD ($2–$4.50) per person per night. This fee is often collected in cash at check-out, so keep cash set aside!</p>
      </div>

      <h2>2. Food & Dining Costs: From Street Food Stalls to Fine Dining</h2>
      <p>Moroccan cuisine is world-famous for its rich aromas, slow-cooked tajines, and fragrant spices. Eating well in Morocco is surprisingly affordable!</p>

      <figure style="margin: 28px 0; text-align: center;">
        <img src="https://images.unsplash.com/photo-1672477179695-7276b0602fa9?w=700&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8dHJhZGl0aW9uYWwlMjBmb29kfGVufDB8fDB8fHww" alt="Traditional Moroccan Tajine and Spiced Dishes" style="width: 100%; max-height: 480px; object-fit: cover; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.08);" />
      </figure>

      <h3>Street Food & Snacks (10 – 35 MAD / $1 – $3.50)</h3>
      <p>The streets of Morocco are an incredible culinary playground. Here are typical street food prices:</p>

      <ul>
        <li><strong>Freshly Squeezed Orange Juice:</strong> 5 – 10 MAD ($0.50 – $1.00) at Jemaa el-Fna stalls.</li>
        <li><strong>Harira Soup with Dates & Chebakia:</strong> 10 – 15 MAD ($1.00 – $1.50).</li>
        <li><strong>Grilled Meat Skewers (Brochettes):</strong> 25 – 40 MAD ($2.50 – $4.00) with bread and chili paste.</li>
        <li><strong>Sfenj (Moroccan Doughnut):</strong> 2 – 3 MAD ($0.20 – $0.30).</li>
        <li><strong>B'stilla Snack (Pastilla):</strong> 20 – 35 MAD ($2.00 – $3.50).</li>
      </ul>

      <h3>Local Neighborhood Canteens (40 – 90 MAD / $4 – $9 per meal)</h3>
      <p>In local eateries just outside tourist medina thoroughfares, a piping hot chicken or lamb tajine with freshly baked khobz (bread) costs around 40 to 60 MAD ($4–$6). A hearty plate of Friday Couscous or Zaalouk (eggplant dip) runs 35 to 50 MAD ($3.50–$5.00).</p>

      <h3>Mid-Range Medina Rooftop Restaurants (120 – 280 MAD / $12 – $28 per meal)</h3>
      <p>Dining at a stylish medina rooftop restaurant with ambient lighting and views over minarets usually costs 120 to 220 MAD ($12–$22) for a starter, main course, and dessert. Soft drinks or mint tea add 15 to 25 MAD.</p>

      <h3>Drinks & Cafe Culture</h3>
      <ul>
        <li><strong>Mint Tea or Espresso at Local Cafe:</strong> 10 – 20 MAD ($1.00 – $2.00).</li>
        <li><strong>Bottled Water (1.5L):</strong> 5 – 8 MAD ($0.50 – $0.80) at local grocery stores.</li>
        <li><strong>Local Beer (Flag Special, Stork):</strong> 35 – 60 MAD ($3.50 – $6.00) in licensed bars/hotels.</li>
        <li><strong>Bottle of Moroccan Wine (Guerrouane, Volubilia):</strong> 120 – 280 MAD ($12 – $28).</li>
      </ul>

      <h2>3. Transportation Costs: Trains, Buses, Taxis & Rental Cars</h2>
      <p>Getting around Morocco is efficient and wallet-friendly thanks to modern infrastructure projects across the Kingdom.</p>

      <h3>High-Speed Trains (Al Boraq) & Conventional ONCF Trains</h3>
      <p>Morocco boasts Africa's first high-speed bullet train, the <strong>Al Boraq</strong>, connecting Tangier, Kenitra, Rabat, and Casablanca in under two hours. Ticket prices are remarkably affordable:</p>

      <ul>
        <li><strong>Tangier to Casablanca (Al Boraq High-Speed):</strong> 150 – 250 MAD ($15 – $25) in 2nd class; 220 – 350 MAD ($22 – $35) in 1st class.</li>
        <li><strong>Casablanca to Marrakech (Standard Train):</strong> 110 – 160 MAD ($11 – $16).</li>
        <li><strong>Fes to Marrakech (Standard Train):</strong> 210 – 310 MAD ($21 – $31).</li>
      </ul>

      <p>You can verify live train schedules and purchase tickets online directly on the official <a href="https://www.oncf.ma/" target="_blank" rel="noopener noreferrer" class="blog-internal-link">ONCF National Railway Portal</a>.</p>

      <h3>Intercity Buses (CTM & Supratours)</h3>
      <p>For destinations not reached by train—such as the blue city of Chefchaouen or the desert gateway of Merzouga—long-distance buses like <strong>CTM</strong> and <strong>Supratours</strong> are comfortable, air-conditioned, and reliable.</p>

      <ul>
        <li><strong>Fes to Chefchaouen (CTM Bus):</strong> 75 – 100 MAD ($7.50 – $10.00).</li>
        <li><strong>Marrakech to Chefchaouen:</strong> ~250 MAD ($25.00).</li>
        <li><strong>Marrakech to Merzouga (Supratours Night Bus):</strong> ~280 MAD ($28.00).</li>
      </ul>

      <h3>City Taxis: Petit Taxis vs. Grands Taxis</h3>
      <p>Within city boundaries, small <strong>Petit Taxis</strong> (colored differently in each city—e.g. red in Marrakech, blue in Chefchaouen, yellow in Fes) are required by law to run on the meter (<em>compteur</em>). A typical ride across town costs 15 to 35 MAD ($1.50–$3.50). Always insist that the driver turns on the meter upon entering!</p>

      <p>For inter-city routes or rural trips, shared <strong>Grands Taxis</strong> (usually Mercedes sedans or vans) carry 6 passengers on fixed routes for 20 to 80 MAD ($2–$8) per seat.</p>

      <h3>Car Rentals & Gasoline</h3>
      <p>Renting a economy car in Morocco costs roughly 250 to 450 MAD ($25–$45) per day. Gasoline (sans plomb) costs approximately 14 to 15 MAD ($1.40) per liter. Highway tolls between major cities add 20 to 60 MAD ($2–$6) per leg.</p>

      <h2>4. Sightseeing, Excursions & Activity Costs</h2>
      <p>Sightseeing in Morocco delivers huge value. Most historic monuments, madrasas, and palaces have standard government-regulated ticket prices.</p>

      <div class="blog-table-container">
        <table>
          <thead>
            <tr style="background-color: #f7f6f5; color: var(--color-charcoal); font-weight: 700; border-bottom: 2px solid var(--color-border);">
              <th style="padding: 12px 16px;">Activity / Attraction</th>
              <th style="padding: 12px 16px;">Cost (MAD)</th>
              <th style="padding: 12px 16px;">Cost (USD)</th>
              <th style="padding: 12px 16px;">Insider Travel Tip</th>
            </tr>
          </thead>
          <tbody>
            <tr style="border-bottom: 1px solid var(--color-border);">
              <td style="padding: 12px 16px; font-weight: 600;">Bahia Palace / Saadian Tombs (Marrakech)</td>
              <td style="padding: 12px 16px;">70 MAD</td>
              <td style="padding: 12px 16px;">~$7 USD</td>
              <td style="padding: 12px 16px;">Go at 8:30 AM right when doors open to avoid tour groups.</td>
            </tr>
            <tr style="border-bottom: 1px solid var(--color-border); background-color: #fdfdfd;">
              <td style="padding: 12px 16px; font-weight: 600;">Majorelle Garden + YSL Museum</td>
              <td style="padding: 12px 16px;">150 – 220 MAD</td>
              <td style="padding: 12px 16px;">~$15 – $22 USD</td>
              <td style="padding: 12px 16px;">Must book online at least 24 hours in advance.</td>
            </tr>
            <tr style="border-bottom: 1px solid var(--color-border);">
              <td style="padding: 12px 16px; font-weight: 600;">Licensed Medina Tour Guide (Half Day)</td>
              <td style="padding: 12px 16px;">300 – 500 MAD</td>
              <td style="padding: 12px 16px;">~$30 – $50 USD total</td>
              <td style="padding: 12px 16px;">Price is per group, not per person. Hire through official tourism offices.</td>
            </tr>
            <tr style="border-bottom: 1px solid var(--color-border); background-color: #fdfdfd;">
              <td style="padding: 12px 16px; font-weight: 600;">Traditional Local Hammam Experience</td>
              <td style="padding: 12px 16px;">20 MAD + 50 MAD scrub</td>
              <td style="padding: 12px 16px;">~$7 USD total</td>
              <td style="padding: 12px 16px;">Bring your own black soap (savon noir) and scrubbing glove (kessa).</td>
            </tr>
            <tr style="border-bottom: 1px solid var(--color-border);">
              <td style="padding: 12px 16px; font-weight: 600;">3-Day Shared Sahara Desert Tour</td>
              <td style="padding: 12px 16px;">1,500 – 2,500 MAD</td>
              <td style="padding: 12px 16px;">~$150 – $250 USD p/p</td>
              <td style="padding: 12px 16px;">Includes minibus transport, camel trek, meals, and dune bivouac.</td>
            </tr>
            <tr style="border-bottom: none; background-color: #fdfdfd;">
              <td style="padding: 12px 16px; font-weight: 600;">Private Luxury Glamping Desert Tour</td>
              <td style="padding: 12px 16px;">4,000 – 10,000+ MAD</td>
              <td style="padding: 12px 16px;">~$400 – $1,000+ USD p/p</td>
              <td style="padding: 12px 16px;">Private 4x4 Land Cruiser, ensuite tent with shower, fine dining under stars.</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <ul>
        <li><strong>Leather Babouche Slippers:</strong> 100 – 220 MAD ($10 – $22).</li>
        <li><strong>Small Handwoven Wool Berber Rug:</strong> 600 – 1,800 MAD ($60 – $180).</li>
        <li><strong>Large Vintage Wool Rug:</strong> 2,500 – 6,000+ MAD ($250 – $600+).</li>
        <li><strong>Pure Cosmetic Argan Oil (100ml):</strong> 100 – 180 MAD ($10 – $18) at certified women's cooperatives.</li>
        <li><strong>Handpainted Ceramic Bowl:</strong> 40 – 120 MAD ($4 – $12).</li>
      </ul>

      <div class="blog-highlight">
        <p><strong>💡 Bargaining Golden Rule:</strong> Always start by offering roughly 40% to 50% of the vendor's opening quote. Keep the tone friendly and lighthearted. If a price doesn't meet your budget, politely say "Shukran" (thank you) and walk away—you will often be called back with a better price!</p>
      </div>

      <h2>6. Tipping (Baksheesh), ATMs & Money Safety</h2>
      <p>Navigating cash, cards, and local tipping customs smooths out your day-to-day journey considerably.</p>

      <h3>Tipping Etiquette in Morocco</h3>
      <p>Tipping (known locally as <em>Baksheesh</em>) is customary and greatly appreciated across the service industry:</p>
      <ul>
        <li><strong>Sit-Down Restaurants:</strong> 10% of the bill total.</li>
        <li><strong>Cafe Waiters:</strong> 2 to 5 MAD.</li>
        <li><strong>Hotel Luggage Porters:</strong> 10 to 20 MAD per bag.</li>
        <li><strong>Gas Station Attendants:</strong> 5 to 10 MAD for windshield washing.</li>
        <li><strong>Private Drivers:</strong> 100 to 200 MAD per day for the group.</li>
        <li><strong>Official Tour Guides:</strong> 150 to 300 MAD per day for the group.</li>
      </ul>

      <h3>ATM & Card Safety Rules</h3>
      <p>Use ATMs attached to major reputable Moroccan bank branches such as <strong>Attijariwafa Bank</strong>, <strong>BMCE Bank of Africa</strong>, or <strong>Banque Populaire</strong>. ATM withdrawal limits are typically capped at 2,000 to 3,000 MAD (~$200–$300) per transaction. Always decline "Dynamic Currency Conversion" (DCC) at ATMs or credit card terminals—always choose to be charged in local MAD currency so your home bank calculates the fair exchange rate.</p>

      <p>For additional official tourism safety and travel advisories, consult the <a href="https://www.visitmorocco.com/" target="_blank" rel="noopener noreferrer" class="blog-internal-link">Moroccan National Tourism Office (VisitMorocco)</a>.</p>

      <h2>7. Total Estimated Cost Scenarios for 7-Day & 10-Day Trips</h2>
      <p>To help you visualize your entire trip expenses, here are real-world estimates for total trip costs (excluding international airfare):</p>

      <h3>7-Day Budget Trip (Backpacker / Solo)</h3>
