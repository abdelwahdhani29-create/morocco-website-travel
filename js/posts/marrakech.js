...
export const postMarrakech = {
  ...
  content: {
    en: `
      ...
      <p>The spatial layout follows precise urban logic: noble, high-value, and fragrant crafts (silk, carpets, perfumes, spices) occupy central covered avenues closest to the historic Ben Youssef Mosque. In contrast, noisier, hot, or malodorous trades (blacksmiths, iron forges, leather tanneries, wood turners) are situated near the outer gates and ramparts of the medina walls.</p>

      <h2>A Guided Tour of Marrakech's Specialized Craft Quarters</h2>
      <p>To truly appreciate the artistry of Morocco, venture beyond main tourist thoroughfares into these specialized guild districts:</p>
      
      <h3>1. Souk Semmarine & Souk El Kebir: The Main Arteries</h3>
      <p>Branching north from Jemaa el-Fnaa square, Souk Semmarine is a covered avenue shaded by massive timber beams. Lined with high-end carpet showrooms, antique jewelry shops, embroidered kaftans, and brass lanterns, it is the widest and most accessible shopping artery in the medina.</p>

      <h3>2. Souk El Attarine: Spices, Brass & Apothecaries</h3>
      <p>Renowned for its gleaming brass lanterns and towering conical pyramids of saffron, cumin, paprika, and <em>Ras el Hanout</em>. Herbalists here offer traditional apothecary remedies, including pure argan oil, rosewater, eucalyptus crystals, and black soap (<em>savon noir</em>) used in hammams.</p>

      <h3>3. Souk Cherratine: The Leather Guild</h3>
      <p>Immersed in the rich, earthy aroma of vegetable-tanned leather, Souk Cherratine is a paradise for leather goods. Here, artisans stitch supple goat, cow, and camel hides into traditional pointed slippers (<em>babouches</em>), weekender travel duffels, belts, and floor poufs.</p>

      <h3>4. Souk Haddaddine & Souk Chouari: Ironwork & Woodcraft</h3>
      <p>In Souk Haddaddine, the rhythmic metallic clanging of hammers against anvils echoes through coal-fired hearths as blacksmiths forge wrought-iron grilles and lanterns. Nearby in Souk Chouari, woodworkers use traditional bow-lathes to turn fragrant cedar and citrus wood into furniture legs and games.</p>

      <h3>5. Souk des Teinturiers & Rahba Kedima (Spice Square)</h3>
      <p>Souk des Teinturiers features skeins of freshly dyed wool hanging overhead in vibrant indigo, saffron yellow, and poppy red to dry in the sun. A short walk leads to Rahba Kedima (Place des Épices), an open square filled with woven straw baskets, herbal tea blends, and traditional knitted caps.</p>

      <h2>How to Inspect Artisan Quality: Carpets, Leather & Spices</h2>
      <p>Distinguishing authentic craftsmanship from cheap commercial imports ensures you take home lasting treasures:</p>
      <ul>
        <li><strong>Hand-Knotted Carpets:</strong> Turn the carpet over to examine the reverse side. Authentic Amazigh carpets feature irregular hand-tied knots and soft wool warp threads, rather than uniform machine-woven grid backings. Perform the 'burn test': ask the dealer to snip a loose thread and light it—pure wool burns slowly with an organic protein smell, whereas synthetic acrylic melts quickly into a hard plastic bead.</li>
        <li><strong>Genuine Leather Goods:</strong> High-quality Moroccan leather is vegetable-tanned using natural oak bark and mimosa tree extracts, producing a supple feel and pleasant woody aroma. Avoid bags with harsh chemical or sharp ammonia smells, which indicate rushed industrial processing.</li>
        <li><strong>Saffron & Ras El Hanout:</strong> True Taliouine saffron consists of deep crimson threads with yellow tips; fake saffron (safflower) turns water bright yellow instantly without imparting an earthy aroma. For Ras el Hanout, ask herbalists to grind whole spices fresh before your eyes rather than purchasing pre-packaged dust.</li>
      </ul>

      <h2>The Art of Respectful Bargaining (Sh'tar)</h2>
      <p>Many travelers find bargaining intimidating, but in Moroccan culture, <em>Sh'tar</em> is not a conflict—it is a lighthearted social interaction based on conversation, humor, and mutual respect. Follow this proven 4-step negotiation strategy:</p>
      <ol>
        <li><strong>Start with Warmth:</strong> Always greet the vendor with a friendly smile and <em>"Salam Alaykum"</em> (Peace be upon you). Express genuine interest in their craft before asking for a price.</li>
        <li><strong>The First Counter-Offer:</strong> When the vendor names an initial price, politely counter with roughly 40% to 50% of their figure. The vendor will act surprised, but they will offer a lower price.</li>
        <li><strong>Finding Midground:</strong> Slowly raise your offer in small increments. If you feel comfortable paying 60% to 70% of the original quote, you have reached a fair deal that respects both your budget and the artisan's labor.</li>
        <li><strong>The Polite Walk-Away:</strong> If the price remains above your budget, place your hand over your heart, say <em>"Shukran"</em> (Thank you), and walk away. If your offer was reasonable, the vendor will frequently call you back to close the sale.</li>
      </ol>

      <h2>A Recommended Walking Route through the Souks</h2>
      <p>Follow this logical, stress-free 2-hour loop through the medina craft quarters:</p>
      <div class="blog-highlight">
        <h3>Medina Craft Walking Loop</h3>
        <p><strong>1. Start at Jemaa el-Fnaa:</strong> Enter northbound via the shaded canopy of <strong>Souk Semmarine</strong>.</p>
        <p><strong>2. Brass & Spices:</strong> Continue straight into <strong>Souk El Attarine</strong> to admire copper lanterns and spice pyramids.</p>
        <p><strong>3. Rahba Kedima:</strong> Turn right into Rahba Kedima (Spice Square) for straw baskets and rooftop herbal teas.</p>
        <p><strong>4. Wool & Leather:</strong> Walk through <strong>Souk des Teinturiers</strong> (Dyers' Souk) and <strong>Souk Cherratine</strong> for leatherwork.</p>
        <p><strong>5. Cultural Finish:</strong> Exit near the historic <strong>Ben Youssef Madrasa</strong>, or double back toward Jemaa el-Fnaa.</p>
      </div>

      <h2>Navigation Tips & Common Scams to Avoid</h2>
      <p>Getting lost in the medina is part of its charm, but staying safe and relaxed is easy with a few simple precautions:</p>
      <ul>
        <li><strong>Offline Maps:</strong> Download offline maps on <em>Maps.me</em> or Google Maps before stepping into the medina. GPS works inside most covered alleyways.</li>
        <li><strong>Dealing with Unsolicited Directions:</strong> If someone approaches claiming "that street is closed" or "the tannery is closing now," politely ignore them with a calm "No, thank you" and keep moving. They are usually trying to divert you to a specific carpet shop or demand a guide fee.</li>
        <li><strong>Heed the Scooter Warning:</strong> Narrow alleyways are shared with fast-moving motorbikes. When you hear shouts of <em>"Balak! Balak!"</em> (Watch out!), step smoothly to the right side of the wall.</li>
        <li><strong>Luggage Limits:</strong> Avoid purchasing heavy unglazed pottery or large fragile glass lanterns unless the shop provides certified international crate shipping.</li>
      </ul>
