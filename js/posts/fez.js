...
export const postFez = {
  ...
  content: {
    en: `
      ...
      <p>Fassi royal court kitchens fused these diverse influences into an elegant culinary style characterized by multi-layered sweet-and-savory flavor combinations, slow braising in heavy clay pots, floral distillates, and complex spice balances. Unlike fast-paced street food elsewhere, traditional Fassi banquet cooking requires hours of meticulous preparation, precise spice roasting, and patient stewing.</p>

      <h2>The Alchemic Spice Palette of Souk El-Attarine</h2>
      <p>To understand the flavor profile of Fez, one must explore the narrow spice lanes of <strong>Souk El-Attarine</strong>. Fassi cooks do not use spices merely to create heat; they layer spices like artists applying pigment to a canvas. The foundation of Fassi seasoning is <strong>Ras el Hanout</strong> (literally 'top of the shop'), a legendary herbal blend that can contain up to 30 dry ingredients, including cinnamon, ginger, cardamom, nutmeg, clove, mace, turmeric, allspice, and dried rosebuds.</p>
      <p>Beyond dry spices, Fassi gastronomy relies heavily on natural floral distillates and regional aromatics. Pure orange blossom water (<em>ma' zhar</em>) and rosewater are sprinkled over fresh fruit salads, sweet pastries, and savory chicken tagines to lift heavy meats. Saffron harvested by hand from crocus blooms in Taliouine gives broths an earthy depth and brilliant golden hue, while preserved lemons (<em>l'hamd marqad</em>) add bright citrus acidity.</p>

      <h2>Iconic Dishes of the Fassi Table</h2>
      <p>When dining in the historic riad courtyards of Fez, these iconic culinary creations are absolute must-try specialties:</p>
      
      <h3>1. Pigeon or Chicken Pastilla (Bstilla)</h3>
      <p>Pastilla is the absolute pinnacle of Moroccan culinary art. It is a large, round pie constructed from dozens of paper-thin sheets of <em>warka</em> pastry dough. Inside lies a rich filling of slow-cooked shredded pigeon (or chicken) stewed with sweet onions, saffron, ginger, and fresh coriander. This is topped with a layer of toasted, crushed almonds blended with sugar, cinnamon, and orange blossom water. After baking to a crisp golden finish, the top is heavily dusted with powdered sugar and ground cinnamon in geometric lattice patterns. The first bite offers an unbelievable contrast of flaky pastry, crunchy almonds, sweet cinnamon, and savory braised meat.</p>

      <h3>2. Tagine Slaoui: Slow-Cooked Lamb with Quinces or Prunes</h3>
      <p>A classic Fassi tagine features tender cuts of lamb or beef slow-braised in a conical clay vessel with seasonal quince fruit (<em>slaoui</em>), caramelized prunes, wild mountain honey, and toasted sesame seeds. The slow braising breaks down meat fibers until tender enough to eat with fresh crusty bread, while the tart quince cuts through the rich sweetness of the honeyed sauce.</p>

      <h3>3. Khlea: The Nomadic Preservation Craft</h3>
      <p>Khlea (or Khliî) is an ancient Fassi preserved beef specialty developed centuries ago to store meat without refrigeration. Strips of lean beef are marinated in garlic, cumin, coriander, and sea salt, sun-dried on rooftop terraces, and then simmered in rendered beef fat and olive oil. In Fez, Khlea is traditionally served hot for breakfast, scrambled with fresh eggs in a clay dish—a rich, savory, and garlic-infused start to the day.</p>

      <h2>A Tour of Fez Medina Street Food Specialties</h2>
      <p>Beyond formal riad dining, wandering the narrow thoroughfares of Tala'a Kebira and Tala'a Seghira reveals a vibrant street food culture:</p>
      <ul>
        <li><strong>Sfenj:</strong> Ring-shaped, golden-fried Moroccan donuts made from yeasted dough. Served piping hot straight from bubbling cauldrons, they are crispy on the outside, airy inside, and often eaten dusted with sugar or dipped in honey alongside morning mint tea.</li>
        <li><strong>Msemen & Melwi:</strong> Layered, flaky square pancakes cooked on flat iron griddles. Enjoy them sweet with honey and soft cheese, or savory stuffed with spiced onions, peppers, and ground beef.</li>
        <li><strong>Brochettes:</strong> Charcoal-grilled skewers of tender spiced lamb, beef, or kefta (seasoned minced meat), wrapped in warm round bread with tomato-onion relish.</li>
        <li><strong>Harira & Babouche (Snail Soup):</strong> Harira is a velvety tomato, lentil, and chickpea soup served with sweet chebakia pastry. For adventurous eaters, street carts serve steaming bowls of land snails (<em>babouche</em>) simmered in a dark herbal broth seasoned with licorice root, thyme, and dried chili pepper.</li>
      </ul>

      <h2>A Suggested One-Day Culinary Itinerary in Fez Medina</h2>
      <ol>
        <li><strong>8:30 AM – 10:00 AM:</strong> Start with an authentic Fassi breakfast of eggs scrambled with Khlea, fresh warm Msemen, goat cheese, and mint tea at a cafe near Bab Bou Jeloud (The Blue Gate).</li>
        <li><strong>10:00 AM – 1:00 PM:</strong> Take a guided food walking tour through Tala'a Kebira. Visit ancient communal bread bakeries (<em>Ferran</em>), olive tasting stalls in Souk El-Attarine, and spice merchants.</li>
        <li><strong>1:00 PM – 2:30 PM:</strong> Enjoy a light lunch of Moroccan cooked salads (Zaalouk, Tektouka, sweet carrot puree) and a vegetable tagine at a shady medina garden courtyard.</li>
        <li><strong>3:00 PM – 6:00 PM:</strong> Attend a hands-on Moroccan cooking class inside a historic riad. Purchase ingredients at local markets and learn to fold paper-thin warka dough for Pastilla.</li>
        <li><strong>7:30 PM – 10:00 PM:</strong> Savor a royal multi-course Fassi dinner featuring homemade Pastilla, lamb tagine with prunes, and Gazelle horn pastries (<em>Kaab el Ghazal</em>) flavored with almond paste and orange blossom water.</li>
      </ol>

      <div class="blog-highlight">
        <h3>Fassi Dining Etiquette & Cultural Rules</h3>
        <p><strong>Bread is Sacred:</strong> In Morocco, round crusty bread (<em>Khobz</em>) is considered a sacred gift. It serves as your primary utensil to scoop up tagine sauces. Never throw bread away or place it upside down on a table.</p>
        <p><strong>Use Your Right Hand:</strong> When eating from a communal tagine dish, eat using only your right hand, using your thumb and first two fingers to pinch bread and scoop meat or vegetables from your section of the dish.</p>
        <p><strong>Ramadan Dining:</strong> During the holy month of Ramadan, street food stalls remain closed during daytime fasting hours, but open with incredible festive energy at sunset for the <em>Iftar</em> (break-fast) feast.</p>
      </div>
